...
exports.AutoTagger = exports.DEFAULT_TAGGER_RULES = exports.STOP_WORDS = exports.EMOTION_DICTIONARY = void 0;
exports.createTagger = createTagger;
exports.quickTag = quickTag;
// ============ 常量定义 ============
/**
 * 情感词典
 */
exports.EMOTION_DICTIONARY = {
    // 正面情感
...
class AutoTagger {
    constructor(config) {
        this.config = config;
        this.rules = exports.DEFAULT_TAGGER_RULES;
        this.emotionDictionary = exports.EMOTION_DICTIONARY;
        this.stopWords = exports.STOP_WORDS;
    ...
    async tag(content) {
        ...
        try {
            ...
            // 并行执行各种标签提取
            const [keywords, emotions, entities, ruleTags,] = await Promise.all([
    ...
    async extractKeywords(content) {
        ...
        // 过滤停用词
        const filteredWords = words.filter(word => word.length >= this.config.minKeywordLength &&
     ...
     * 合并所有标签
     */
    mergeTags(keywords, emotions, entities, ruleTags) {
        const allTags = [
            ...keywords.words,
            ...emotions.tags,
            ...entities.tags,
 ...
 * 快速打标函数
 */
async function quickTag(content, config) {
